const baseUrl = "https://vault.smswithoutborders.com/v3";
...
window.onload = () => {
  ...
  if (format_value == "month" || format_value == "day") {
    const URL = `${baseUrl}/entities?start=${start_date.value}&end=${end_date.value}&type=${type.value}&format=${format_value}`;
