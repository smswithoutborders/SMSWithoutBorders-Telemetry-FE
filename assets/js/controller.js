...
window.onload = () => {
    if (category.value == "months") {
        ...
        fetchData(URL, category.value, start_date.value, end_date.value, table_data, table_head, type.value);
        ...
        fetchData(URL, "months", start_date.value, end_date.value, table_data, table_head, "active");
    }
